<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Admin/Admin.Master" EnableSessionState="false" AutoEventWireup="true" CodeBehind="Orders.aspx.cs" Inherits="AspNet4.Pages.Admin.Orders" %>
            ...
            <asp:Repeater ID="Repeater1" runat="server" SelectMethod="GetOrders"
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:PlaceHolder ID="PlaceHolder1" Visible="<%# !Item.Dispatched %>"
                                runat="server">
